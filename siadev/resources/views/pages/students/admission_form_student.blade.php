                ...
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <select class="form-control select2" name="department" required>
                            <option value="" disabled>Selecionar *</option>
                            <option value="1"
                                {{ old('department', $student->department ?? '') == '1' ? 'selected' : '' }}>Enfermagem
                            </option>
                            <option value="2"
                                {{ old('department', $student->department ?? '') == '2' ? 'selected' : '' }}>Medicina Geral
                            </option>
                        </select>
                    </div>
                    <div class="col-md-3 form-group">
                        ...
                        <select class="form-control select2" name="semester" required>
                            <option value="" disabled>Selecionar *</option>
                            <option value="1"
                                {{ old('semester', $student->semester ?? '') == '1' ? 'selected' : '' }}>Semestre I
                            </option>
                            <option value="2"
                                {{ old('semester', $student->semester ?? '') == '2' ? 'selected' : '' }}>Semestre II
                            </option>
                            <option value="3"
                                {{ old('semester', $student->semester ?? '') == '3' ? 'selected' : '' }}>Semestre III
                            </option>
                        </select>
                    </div>
                    <div class="col-md-3 form-group">
