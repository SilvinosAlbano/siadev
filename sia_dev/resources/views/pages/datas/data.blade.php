            ...
            <div class="card-body border">
                <div class="heading-layout1">
                    <div class="item-title">
                        <h3>Formulario Submissão Datas</h3>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ isset($mat) ? route('datas.update', $mat->id_datas) : route('datas.store') }}">
                    @csrf
                    @if(isset($mat))
                        @method('PUT')
                    @endif
                    ...
                    <div class="row">
                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                            ...
                            <input type="date" name="data" value="{{ isset($mat) ? $mat->data : old('data') }}" class="form-control border" required>
                        </div>
    ...
    <div class="col-8-xxxl col-12">
        <div class="card height-auto">
            <div class="card-body border">
                <div class="heading-layout1">
                    <div class="item-title">
                        <h3>Todos Data Configuracoes</h3>
                    </div>
                </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <!-- Delete Button -->
                                            <form action="{{ route('datas.destroy', $mat->id_datas) }}" method="POST" onsubmit="return confirm('Tem certeza de apagar este dados?');">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <!-- Edit Button -->
                                            <a class="dropdown-item" href="{{ route('datas.edit', $mat->id_datas) }}"><i class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
