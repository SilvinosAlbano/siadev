                        ...
                        <li>
                            <div class="col-lg-12 col-12 form-group mg-t-30">
                                <form action="/import-excel" method="POST" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" class="btn-fill-md text-light bg-dodger-blue"> <i
                                            class="fas fa-file-excel text-success"></i> Upload</button>
                                </form>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="card-body">
            <div class="heading-layout1">
                ...
                @if (Auth::user()->canAccess('Create', 'admission_form_student') ||
                    ...
                    <li>
                        <a class="btn-fill-md text-light bg-dodger-blue" href="/students/create"> Inserir Novo <i
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if (Auth::user()->canAccess('Delete', 'students'))
                                        <form
                                            action="{{ route('students.destroy', ['id_student' => $student->id_student]) }}"
