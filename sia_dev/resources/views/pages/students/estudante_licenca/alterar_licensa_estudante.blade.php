                        ...
                        <div class="card-body border">
                            <div class="heading-layout1">
                                <div class="item-title">
                                    <h3>Licenca Estudante Alterar</h3>
                                </div>
                            ...
                            <form class="new-added-form mb-4" method="POST" action="{{ route('licensa_estudante.store') }}"   enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-4-xxxl col-lg-4 col-12 form-group">
                                        <label>Tipo Licensa *</label>
                                             <select class="select2" name="id_tipo_licensa">
                                                ...
                                                <option value="{{ $row->id_tipo_licensa }}" {{ $student->id_tipo_licensa == $row->id_tipo_licensa ? 'selected' : '' }}>
                                                    {{ $row->nome_tipo_licensa }}
                                                </option>
                                            @endforeach
                                            </select>
                                    </div>
                                    <div class="col-4-xxxl col-lg-4 col-12 form-group">
                                        ...
                                        <input type="date" name="data_inicio_licensa" value="{{$licensa->data_inicio_licensa}}" class="form-control border" required>
                                    </div>

                                  
                                    <div class="col-4-xxxl col-lg-4 col-12 form-group">
                                        <label>Data Fim Licensa*</label>
                                        <input type="date" name="data_fim_licensa" value="{{$licensa->data_fim_licensa}}" class="form-control border" required>
                                    </div>
