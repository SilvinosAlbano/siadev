...
@extends('layouts.app')
@section('title', 'Naturalidade Inserir')
@section('content') 
    <!-- Identificao Content -->
                        ...
                        <div class="card-body border">
                            <div class="heading-layout1">
                                <div class="item-title">
                                    <h3> Inserir Naturalidade de Estudante</h3>
                                </div>
                            
                            </div>
                        
                            <form class="new-added-form mb-4" method="POST" action="{{ route('store_naturalidade_estudante') }}"   enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                        ...
                                        <input type="text" name="nacionalidade" placeholder="" required class="form-control border">
                                        <!-- <input type="hidden" name="id_docente"> -->
                                    </div>
                                    <div class="col-xl-4 col-lg-6 col-12 form-group">
                                        <label>Endereco Atual *</label>
                                        <input type="text" name="endereco_atual" placeholder="" required class="form-control border">
                                        <!-- <input type="hidden" name="id_docente"> -->
                                    </div>
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    ...
                                    <a href="{{ route('students.detail', $student->id_student) }}" class="btn-fill-lg bg-blue-dark btn-hover-yellow">Cancelar</a>
                                </div>
