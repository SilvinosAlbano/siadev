<div class="container">
    ...
    <button class="btn btn-lg btn-primary" data-bs-toggle="modal" data-target="#createModal"
        id="openModalBtn">Adicionar</button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createModalLabel">Adicionar Novo disciplinas</h5>
                    <div class="close-btn">
