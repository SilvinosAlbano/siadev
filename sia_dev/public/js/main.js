  ...
  $(function () {
    ...
    /*-------------------------------------
      ...
      if ($("#earning-line-chart").length) {
        // Prepare labels and data for the chart based on earningData
        const labels = earningData.map(item => item.year);  // Years
        const dataPoints = earningData.map(item => item.total_earning);  // Earnings
        ...
        var lineChartOptions = {
            ...
            scales: {
                xAxes: [{
                    display: true,
                    ticks: { fontColor: "#222222", fontSize: 16, padding: 20 },
                    gridLines: { color: '#cccccc', borderDash: [5, 5] }
                }],
                yAxes: [{
                    display: true,
                    ticks: {
                        fontColor: "#646464", fontSize: 16, padding: 20,
                        callback: function(value) { return `${value / 1e3}k`; }
                    },
                    gridLines: { color: '#cccccc', borderDash: [5, 5] }
                }]
            },
        ...
        new Chart(earningCanvas, { type: 'line', data: lineChartData, options: lineChartOptions });
    }
